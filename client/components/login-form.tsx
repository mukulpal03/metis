      ...
      <Card className="border-border/60 bg-card/80 shadow-2xl backdrop-blur-sm">
        <CardHeader className="space-y-3 text-center">
          ...
          <div>
            ...
            <CardDescription className="text-sm text-muted-foreground mt-1">
              Sign in to authorize your Metis CLI & developer environment
            </CardDescription>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-12 relative font-medium hover:bg-accent hover:text-accent-foreground transition-all duration-200 text-base"
        ...
        <CardFooter className="flex flex-col items-center justify-center border-t border-border/40 py-4">
          <p className="text-center text-xs text-muted-foreground font-mono">
            $ metis auth login --web
          </p>
        </CardFooter>
      </Card>
    </div>
