...
function DeviceApprovalContent() {
  ...
  if (!data?.session && !data?.user) {
    const redirectPath = `/approve?user_code=${encodeURIComponent(userCode || "")}`;
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-3">
            <Button
              ...
              className="w-full h-11 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <Button
              ...
              className="w-full h-11 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2 cursor-pointer"
            >
              {isProcessing.deny ? (
                <>
                  <Spinner className="w-4 h-4 text-white" />
